...
function theData = ON_study_round11(thePath,listName,sName, sNum, S,EncBlock, startTrial)
...
initStimTime = 1.5; % stim time before sound
...
toneSet = {'tone1.wav' 'tone2.wav' 'tone3.wav'};
% %preload sounds
