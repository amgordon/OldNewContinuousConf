...
for Trial = 1:listLength
    ...
    % for the rest of the trial, get the mouse coordinates
    while (GetSecs - ons_begin_study)<desiredEndTime
        ...
        % if the mouse was clicked on the bar, record information, hide the
    ...
    % once a response is collected, finish the trial
    while (GetSecs - ons_begin_study)<desiredEndTime
        WaitSecs(.005);
    end
