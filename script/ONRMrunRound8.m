...
if testType == 1
    ...
    listName = sprintf('546_words_Study_List_Salience_%g.mat', 1+mod(sNum-1, 16));
    respSelData(1) = ON_study_round8(thePath,listName,sName,sNum,S,1, 1);
...
elseif testType == 2
    ...
    listName = ['1092_words_Test_List_Salience_' num2str(1+mod(sNum-1,16)) '_' num2str(1) '.mat'];
...
elseif testType == 3
    ...
    saveName = ['ON_studyPrac1_round8' sName '_' num2str(sNum) '.mat'];
    
    listName = '546_words_Study_List_NoAC_prac1.mat';
    pracData(1) = ON_studyPrac1_round8(thePath,listName,sName,sNum,S,1, 1);
...
elseif testType == 4
    ...
    saveName = ['ON_studyPrac2_round8' sName '_' num2str(sNum) '.mat'];
    
    listName = '546_words_Study_List_NoAC_prac2.mat';
    pracData(1) = ON_studyPrac2_round8(thePath,listName,sName,sNum,S,1, 1);
